...
@author: lgw
"""
#CCSDS(128,64)  2.0-3.2-0.2dB, NMS-1(T=13)
ldpc_testing_fer = [(2.2,0.3445),(2.4,0.2666),(2.6,0.1968),(2.8,0.1390),(3.0,0.0948),(3.2,0.0593)]
#CCSDS(128,64) 2.2-3.2-0.2dB, DIA(30)-size(32)-auxiliary-diversify(2)
osd_fer1 = [(2.2,0.034),(2.4,0.02469),(2.6,0.01798),(2.8,0.01279),(3.0,0.01055),(3.2,0.00496)]
#CCSDS(128,64) 2.2-3.2-0.2dB, DIA(100)-size(32)-auxiliary-diversify(2)
osd_fer2 = [(2.2,0.02349),(2.4,0.01648),(2.6,0.01065),(2.8,0.00809),(3.0,0.00518),(3.2,0.00288)]
#CCSDS(128,64) 2.2-3.2-0.2dB, DIA(100)-size(32)-auxiliary-diversify(2)
osd_fer3 = [(2.2,0.01971),(2.4,0.01333),(2.6,0.00782),(2.8,0.00589),(3.0,0.00358),(3.2,0.00248)]
osd_fer_order_3_list = [osd_fer1,osd_fer2,osd_fer3]
order_3_fer_list = []
for k in range(3):
    order_3_fer = [round(ldpc_testing_fer[i][1]*osd_fer_order_3_list[k][i][1],5) for i in range(len(ldpc_testing_fer[:6]))]
